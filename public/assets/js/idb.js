...
request.onsuccess = function (event) {
	...
	if (navigator.onLine) {
		...
		// checks to see if we're online everytime this app opens and uploads any remnant pizza data
...
// will be used in add-pizza.js file's form submission function if fetch() function's catch() method is executed
